...
jQuery.fn = jQuery.prototype = {
	...
	même: function () {
		renvoie this.pushStack (jQuery.grep (this, function (_elem, i) {
			retourne (i + 1)% 2;
		}));
	},
...
function matcherFromGroupMatchers (elementMatchers, setMatchers) {
	var bySet = setMatchers.length> 0,
		...
		superMatcher = fonction (graine, contexte, xml, résultats, la plus externe) {
			...
			// cas, qui se traduira par un "00" "matchedCount" qui diffère de "i" mais qui est également
			// numériquement zéro.
...
// Support: W ebkit <537.32 - Safari 6.0.3 / Chrome 25 (corrigé dans Chrome 27)
